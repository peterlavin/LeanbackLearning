	...
	var t = "";
			...
			console.log("body :"+res.statusCode);
				...
				if (oo["-1"] != undefined) {
					...
					if(t.indexOf("</b> may refer to:</p>") != -1||t.indexOf("commonly refers to") != -1||t.indexOf("</b> peut faire référence à :</p>") != -1||t.indexOf("peut faire r\u00e9f\u00e9rence \u00e0\u00a0:</p>") != -1||t.indexOf("</b> steht als Abkürzung für:</p>") != -1||t.indexOf("</b> steht als Abk\u00fcrzung f\u00fcr:</p>") != -1)
								{
